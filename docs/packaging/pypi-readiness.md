...
The examples intentionally use an approved-version placeholder. Confirm the
live version on PyPI and the GitHub Releases page rather than inferring it from
