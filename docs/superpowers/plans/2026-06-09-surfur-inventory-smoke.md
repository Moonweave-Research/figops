...
rendering in FigOps MCP runtime snapshots.
...
**Files:**
- Create: `docs/02-design/surfur_figops_mcp_targets_20260609.md`
- Create: `docs/02-design/surfur_figops_mcp_targets_20260609.json`
