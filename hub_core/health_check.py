...
import subprocess
import shutil
from .ui_utils import ui_print, ui_panel
...
def check_env_vars():
    ...
    missing = []
    if not os.environ.get("PROJECT_ROOT"): missing.append("PROJECT_ROOT")
    if not os.environ.get("RESEARCH_HUB_PATH"): missing.append("RESEARCH_HUB_PATH")
